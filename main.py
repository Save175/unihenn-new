...
if __name__ == "__main__":
    ...
    if file_type < 1 or file_type > 15:
    ...
    files = ['example/M1_test.py',
             ...
             'example/M5_test.py',
             'example/M6_test.py',
             'example/M7_test.py','example/M8_test.py','example/M9_test.py','example/M10_test.py','example/M11_test.py','example/M12_test.py','example/M13_test.py','example/M15_test.py']
